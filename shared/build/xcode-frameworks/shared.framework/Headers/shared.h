...
*/
- (void)loadRecipesWithCompletionHandler:(void (^)(SharedRecipeList * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("loadRecipes(completionHandler:)")));
@property (readonly) SharedKtor_client_coreHttpClient *httpClient __attribute__((swift_name("httpClient")));
@end;

__attribute__((swift_name("IRecipeModel")))
@protocol SharedIRecipeModel
@required
- (void)loadRecipes __attribute__((swift_name("loadRecipes()")));
@property id<SharedIRecipeUpdater> _Nullable recipeAdapter __attribute__((swift_name("recipeAdapter")));
@end;

__attribute__((swift_name("IRecipeUpdater")))
@protocol SharedIRecipeUpdater
@required
- (void)setupItemsItems:(NSArray<SharedRecipe *> *)items __attribute__((swift_name("setupItems(items:)")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeModel")))
@interface SharedRecipeModel : SharedBase <SharedIRecipeModel>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)loadRecipes __attribute__((swift_name("loadRecipes()")));
@property (readonly) id<SharedKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
...
- (instancetype)initWithTitle:(NSString * _Nullable)title ingredients:(NSString * _Nullable)ingredients thumbnail:(NSString * _Nullable)thumbnail __attribute__((swift_name("init(title:ingredients:thumbnail:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (SharedRecipe *)doCopyTitle:(NSString * _Nullable)title ingredients:(NSString * _Nullable)ingredients thumbnail:(NSString * _Nullable)thumbnail __attribute__((swift_name("doCopy(title:ingredients:thumbnail:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
